...
@register_binary_sensor("tcl112", TCL112BinarySensor, TCL112_SCHEMA)
def tcl112_binary_sensor(var, config):
    cg.add(
        var.set_data(
            cg.StructInitializer(
                TCL112Data,
...
@register_trigger("tcl112", TCL112Trigger, TCL112Data)
def tcl112_trigger(var, config):
    pass


@register_dumper("tcl112", TCL112Dumper)
def tcl112_dumper(var, config):
    pass
